...
public class ProductDAO {
    ...
    List<Category> snacks = new ArrayList<>();
    List<Category> home_cleaning = new ArrayList<>();

    public ProductDAO(){
        pantry.add(new Category(1,"Skafferi"));
        snacks.add(new Category(2,"Snacks-godis"));
        home_cleaning.add(new Category(3,"Hem-städ"));
    }
